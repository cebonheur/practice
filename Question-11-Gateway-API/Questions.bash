# Question
# You have an existing web application deployed in a Kubernetes cluster using an Ingress resource named web in the q11-default namespace.
...
# Note: A GatewayClass named q11-nginx-class is already installed in the cluster (it belongs to the q11 environment)
