# Question HPA
# Create a new HorizontalPodAutoScaler(HPA) named apache-server in the q5-autoscale namespace

# Task
# 1. The HPA must target the existing deployment called apache-deployment in the q5-autoscale namespace
