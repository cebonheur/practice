...
# Task
# 1. Expose the existing deployment with a service called echo-service in the q12-echo-sound namespace
# using Service Port 8080 type=NodePort
# 2. Create a new ingress resource named echo in the q12-echo-sound namespace for http://example.org/echo
