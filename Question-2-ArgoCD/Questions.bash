...
# 2. Create a namespace called q2-argocd
# 3. Generate a Helm template from the Argo CD chart version 7.7.3 for the q2-argocd namespace
# 4. Ensure that CRDs are not installed by configuring the chart accordingly
# 5. Save the generated YAML manifest to ~/questions/q2/argo-helm.yaml
