# Question:
# There is an existing deployment in the q15-nginx-static namespace. The deployment contains a ConfigMap that supports
# TLSv1.2 and TLSv1.3 as well as a Secret for TLS.

# There is a service called nginx-static in the q15-nginx-static namespace that is currently exposing the deployment.
